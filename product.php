        ...
        <div class = "filter-container">
            ...
            <div class = "posts-collect">
                <div class = "posts-main-container">
                    <div class = "all celling-fans">
                        <div class = "post-img">
                            <img src = "images\quat-tran-5-canh-go-co-den-mrvu-villa-300x300.jpg" alt = "post">
                            <span class = "category-name">Celling Fans</span>
                        </div>

                        <div class = "post-content">
                            <div class = "post-content-top">
                                <span><i class = "fas fa-coins"></i>10.213.132 d</span>
                                <span>
                                    <i class = "fas fa-comment"></i>
                                </span>
                            </div>
                            <h2>Quạt trần villa</h2>
                        </div>
                        <button type = "button" class = "read-btn">More Info</button>
                    </div>
                    ...
                    <div class = "all pedestal-fans">
                        <div class = "post-img">
                            <img src = "images\quat-tran-5-canh-go-co-den-mrvu-villa-300x300.jpg" alt = "post">
                            <span class = "category-name">Pedestal Fans</span>
                        </div>
                    ...
                    <div class = "all wall-fans">
                        <div class = "post-img">
                            <img src = "images\quat-tran-5-canh-go-co-den-mrvu-villa-300x300.jpg" alt = "post">
                            <span class = "category-name">Wall Fans</span>
                        </div>
                    ...
                    <div class = "all exhaust-fans">
                        <div class = "post-img">
                            <img src = "images/quat-tran-5-canh-go-co-den-mrvu-villa-300x300.jpg" alt = "post">
                            <span class = "category-name">Exhaust Fans</span>
                        </div>
